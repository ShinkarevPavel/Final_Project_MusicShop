...
<%--    <link type="text/css" rel="stylesheet" href="${abs_path}/pages/css/instrumentsStyle.css"/>--%>
<%--    <link href="${pageContext.request.contextPath}/pages/css/rating.css/rating.css" rel="stylesheet"/>--%>
