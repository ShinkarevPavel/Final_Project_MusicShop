...
public enum CommandName {
    ...
    SHOW_INSTRUMENT_BY_TYPE_COMMAND(new ShowInstrumentByTypeCommand(), EnumSet.of(ADMIN)),
    SHOW_INSTRUMENT_DETAILS_COMMAND(new ShowInstrumentDetailsCommand(), EnumSet.of(ADMIN, CLIENT)),
    SET_INSTRUMENT_RATING_COMMAND(new SetInstrumentRatingCommand(), EnumSet.of(ADMIN, CLIENT)),
